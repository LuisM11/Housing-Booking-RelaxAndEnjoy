...
function Seeker() {
  return (
    <section className="w-full h-64 bg-thirdColor flex flex-col justify-around items-center">
      <h2 className="w-96 h-20 font-bold text-fourthColor text-2xl text-center leading-9">
        Busca ofertas en hoteles, casas y mucho mas
      </h2>
      <form action="" className="w-11/12 flex flex-col gap-3">
        <select name="destinos" id="" defaultValue="¿A donde vamos?" className="h-9 rounded shadow-2xl p-1">
        ...
        <button
          type="submit"
          className="h-10 bg-mainColor text-fourthColor rounded shadow-2xl"
        >
          Buscar
        </button>
      </form>
