...
const ContextProvider = ({ children }) => {
  ...
  const getCategoriesList = async () => {
    return await axios
      .get("http://3.139.250.124:8080/categories")
      .then((resp) => setCategoriesList(resp.data));
  };
  const getCitiesList = async () => {
    return await axios
      .get("http://3.139.250.124:8080/cities")
      .then((resp) => resp.data);
  };
  const getFeaturesList = async () => {
    return await axios
      .get("http://3.139.250.124:8080/features")
      .then((resp) => resp.data);
  };

  const getProductsList = async () => {
    return await axios
      .get("http://3.139.250.124:8080/products")
      .then((resp) => resp.data);
  };

  const getProductById = async (id) => {
    return await axios
      .get(`http://3.139.250.124:8080/products/${id}/`)
      .then((resp) => resp.data);
  };
  const getProductsByCategory = async (id) => {
    return await axios
      .get(`http://3.139.250.124:8080/products/category/${id}/`)
      .then((resp) => resp.data);
  };

  const getProductsWithParams = async (params) => {
    return await axios
      .get(`http://3.139.250.124:8080/products/?${params}`)
      .then((resp) => resp);
  };

  const getProductReservations = async (id) => {
    return await axios
      .get(`http://3.139.250.124:8080/products/${id}/reservation`)
      .then((resp) => resp);
  };
